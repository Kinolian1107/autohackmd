# AutoHackMD - Gemini CLI Instructions

> Instructions for Gemini CLI. When creating markdown content related to study, research, or summary, follow this workflow to save locally and upload to HackMD.
