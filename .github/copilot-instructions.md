# AutoHackMD - GitHub Copilot Instructions

> Repository-level instructions for GitHub Copilot. When creating markdown content related to study, research, or summary, follow this workflow to save locally and upload to HackMD.
...
3. `~/git/autohackmd/`
4. The directory containing this file's parent repo
